...
public class BST<E extends Comparable<E>> {
	...
	public int countRightNodes() {
		...
		if (root.left != null) {
			rightSum += countRightNodes(root.left);
		}

		if (root.right != null) {
			rightSum += 1 + countRightNodes(root.right);
			return rightSum;
		}
		return rightSum;
	...
	private int countRightNodes(TreeNode treeNode) {
		if (treeNode != null) {
			if (treeNode.right != null) {
				return 1 + countRightNodes(treeNode.right) + countRightNodes(treeNode.right);
			} else {
				return countRightNodes(treeNode.right);
			}
		}
		return 0;
	}
	...
	/** Reverse order traversal from the root */
	...
	public static void main(String[] args) {
		// has 3 leaves
		Integer[] nodes = { 19, 47, 23, -2, 5, 63, 94, 28 };
		BST<Integer> tree = new BST<Integer>(nodes);
		System.out.println("The number of Right Nodes is : " + tree.countRightNodes());
		System.out.println("Correct answer is 5");
		System.out.println();

		// has 1 leave
		Integer[] nodes2 = { 12, 1 };
		tree = new BST<Integer>(nodes2);
